  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="../assets2/img/clients/logo_unikom_kuning.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">INVENTORI PEGAWAI</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block"><i></i>Admin</a>
        </div>
      </div>
    ...
    <?php  
      ...
      if(!empty($_GET['menu'])){
        ...
        if($menu == 1){
          ...
          include'tunjangan/tunjangan.php';
        }elseif($menu == 4) {
          ...
          include'tunjangan/form_edit_tunjangan.php';  
         }elseif($menu == 8) {
          include'pengajian/pengajian.php';
        }elseif($menu == 9) {
          include'pengaduan/dikerjakan.php';
         }elseif($menu == 10) {
          include'dashboard.php';
        }elseif($menu == 11) {
          include'generate/cetaklaporan.php';
        }elseif($menu == 12) {
          include'pengaduan/pengaduan_ditolak.php';
        }elseif($menu == 13) {
          include'pengaduan/form_pengaduan_ditolak.php';
        }else{
          include'error.php';
        }
      }else{
